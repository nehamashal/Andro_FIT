...
- (NSURLSessionDataTask *)request:(nonnull id<RGLCProviderTarget>)target completion:(nullable void(^)(id _Nullable response, NSError * _Nullable error))completion;

- (NSURLSessionDataTask *)loadDataRequest:(id<RGLCProviderTarget>)target completion:(void (^)(id _Nullable, NSError * _Nullable))completion;
